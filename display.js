module.exports = function(RED) {
  ...
  function DebugNode(n) {
    ...
    this.on("input",function(msg) {
      ...
      if (this.active) {
        sendDebug({id:node.id, z:node.z, name:node.name, topic:msg.topic, property:property, msg:output, _path:msg._path, showHeader:false, propertyIsFromMsg:propertyIsFromMsg, showTopic:showTopic, showFormat:showFormat, collapseStringQuote: false});
      }
    });
  }
